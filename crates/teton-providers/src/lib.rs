...
mod tests {
    ...
    /// The three vendor spellings, each in the envelope its vendor actually
    ...
    /// message (DeepSeek/vLLM wording), and Anthropic's message.
    const CONTEXT_LENGTH_BODIES: [(&str, &str); 4] = [
        (
