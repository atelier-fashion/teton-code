...
- [ ] AC-4: both ceiling sweeps include the 200-char-root row and pass with `REDACT_BODY_OVERHEAD_BYTES`/`MIN_PROMPT_HEADROOM_BYTES` unchanged; the note records the measured margin at this task's tip.
